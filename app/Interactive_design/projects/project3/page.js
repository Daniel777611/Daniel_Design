...
export default function Project3() {
    ...
    const images = [
        ...
        "/projects/interactive_design/project3/3.jpg",
        "/projects/interactive_design/project3/4.jpg",
        "/projects/interactive_design/project3/5.jpg",
        "/projects/interactive_design/project3/6.jpg",
        "/projects/interactive_design/project3/7.jpg",
        "/projects/interactive_design/project3/8.jpg",
        "/projects/interactive_design/project3/9.jpg",
    ];
                    ...
                    <div className={styles.galleryGrid}>
                        <Link href="/Interactive_design/projects/project1">
                            <div className={styles.galleryItem}>
                                <Image src="/projects/interactive_design/project1/1.jpg" alt="Project 1 Cover" width={800} height={600} className={styles.galleryImage} />
                            </div>
                        </Link>
