    ...
    return (
        <div>
            ...
            <header className={styles.header}>
                ...
                <nav>
                    <ul className={styles.navList}>
                        <li><Link href="/industrial_design/#project-gallery">Projects</Link></li>
            ...
            <Link href="/industrial_design/projects/project1">
                ...
                <Image src="/projects/industrial_design/project1/1.jpg" alt="Best Project Cover" className={styles.bestProjectImage} width={1920} height={1080}/>
                </div>
                </Link>
                        ...
                        <div className={styles.galleryGrid}>
                            ...
                            <Link href="/industrial_design/projects/project1">
                                <div className={styles.galleryItem}>
                                    <Image src="/projects/industrial_design/project1/1.jpg" alt="Project 1 Cover" className={styles.galleryImage} width={800} height={600} />
                            ...
                            <Link href="/industrial_design/projects/project2">
                                <div className={styles.galleryItem}>
                                    <Image src="/projects/industrial_design/project2/1.jpg" alt="Project 2 Cover" className={styles.galleryImage} width={800} height={600}/>
