...
export default function Project1() {
    ...
    useEffect(() => {
        ...
        // fallback 颜色 + 渐变图片（使用 important 覆盖全局）
    ...
    const images = [
        "/projects/industrial_design/project1/1.jpg",
        "/projects/industrial_design/project1/2.jpg",
        "/projects/industrial_design/project1/3.jpg",
        "/projects/industrial_design/project1/4.jpg",
    ]; 
