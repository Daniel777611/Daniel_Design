...
export default function Project3() {
    ...
    const images = [
        "/projects/ux_engineering/project3/1.jpg",
        "/projects/ux_engineering/project3/2.jpg",
        "/projects/ux_engineering/project3/3.jpg",
        "/projects/ux_engineering/project3/4.jpg",
        "/projects/ux_engineering/project3/5.jpg",
        "/projects/ux_engineering/project3/6.jpg",
        "/projects/ux_engineering/project3/7.jpg",
        "/projects/ux_engineering/project3/8.jpg",
        "/projects/ux_engineering/project3/9.jpg",
    ];
    ...
    return (
        <div>
            ...
            <section className={styles.videoSection}>
                ...
                >
                    <source src="https://danieldesignvideo.org/videos/Illuminated_Distance.mp4" type="video/mp4" />
            ...
            <section id="project-gallery" className={styles.gallerySection}>
                <div className={styles.galleryContainer}>
                    <div className={styles.galleryGrid}>
                        <Link href="/ux_engineering/projects/project1">
                            <div className={styles.galleryItem}>
                                <Image src="/projects/ux_engineering/project1/1.jpg" alt="Project 1 Cover" width={800} height={600} className={styles.galleryImage} />
                            </div>
                        </Link>
