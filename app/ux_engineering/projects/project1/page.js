...
export default function Project1() {
    ...
    const images = [
        "/projects/ux_engineering/project1/1.jpg",
        "/projects/ux_engineering/project1/2.jpg",
        "/projects/ux_engineering/project1/3.jpg",
        "/projects/ux_engineering/project1/4.jpg",
        "/projects/ux_engineering/project1/5.jpg",
        "/projects/ux_engineering/project1/6.jpg",
        "/projects/ux_engineering/project1/7.jpg",
        "/projects/ux_engineering/project1/8.jpg",
        "/projects/ux_engineering/project1/9.jpg",
        "/projects/ux_engineering/project1/10.jpg",
        "/projects/ux_engineering/project1/11.jpg",
        "/projects/ux_engineering/project1/12.jpg",
        "/projects/ux_engineering/project1/13.jpg",
        "/projects/ux_engineering/project1/14.jpg",
        "/projects/ux_engineering/project1/15.jpg",
        "/projects/ux_engineering/project1/16.jpg",
    ]; 
            ...
            <header className={styles.header}>
                ...
                <nav>
                    <ul className={styles.navList}>
                        <li><Link href="/ux_engineering/#project-gallery">Project</Link></li>
             ...
             <section id="project-gallery" className={styles.gallerySection}>
                <div className={styles.galleryContainer}>
                    <div className={styles.galleryGrid}>
                        ...
                        <Link href="/ux_engineering/projects/project2">
                            <div className={styles.galleryItem}>
                                <Image src="/projects/ux_engineering/project2/1.jpg" alt="Project 2 Cover" width={800} height={600} className={styles.galleryImage} />
                            </div>
                        </Link>


                        <Link href="/ux_engineering/projects/project3">
                                <div className={styles.galleryItem}>
                                    <Image src="/projects/ux_engineering/project3/1.jpg" alt="Project 3 Cover" className={styles.galleryImage} width={800} height={600} />
