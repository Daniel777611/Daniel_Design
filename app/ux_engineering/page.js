...
import styles from './ux_engineering.module.css';
    ...
    return (
        <div>
            ...
            <header className={styles.header}>
                ...
                <nav>
                    <ul className={styles.navList}>
                        <li><Link href="/ux_engineering/#project-gallery">Projects</Link></li>
            ...
            <Link href="/ux_engineering/projects/project1">
                ...
                <Image src="/projects/ux_engineering/project1/1.jpg" alt="Best Project Cover" className={styles.bestProjectImage} width={1920} height={1080}/>
                </div>
                </Link>
                        ...
                        <div className={styles.galleryGrid}>
                            ...
                            <Link href="/ux_engineering/projects/project1">
                                <div className={styles.galleryItem}>
                                    <Image src="/projects/ux_engineering/project1/1.jpg" alt="Project 1 Cover" className={styles.galleryImage} width={800} height={600} />
                            ...
                            <Link href="/ux_engineering/projects/project2">
                                <div className={styles.galleryItem}>
                                    <Image src="/projects/ux_engineering/project2/1.jpg" alt="Project 2 Cover" className={styles.galleryImage} width={800} height={600}/>
